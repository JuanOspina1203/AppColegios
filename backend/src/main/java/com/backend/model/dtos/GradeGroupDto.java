...
public class GradeGroupDto {
    ...
    private List<String> gradeGroupStudentIdsEnrolled;
    ...
    public List<String> getGradeGroupStudentIdsEnrolled() {return this.gradeGroupStudentIdsEnrolled;}
    public void setGradeGroupStudentIdsEnrolled(List<String> gradeGroupStudentIdsEnrolled) {this.gradeGroupStudentIdsEnrolled = gradeGroupStudentIdsEnrolled;}
}